...
Information.Text = "> This scripts needs a HUGEEEE rework"
...
InputCMD.PlaceholderText = "Execute Command Here"
InputCMD.Text = ""
...
CloneInfo.Text = "> This scripts needs a HUGEEEE rework"
...
if CNAME == "clear " or CNAME == "remove" or CNAME == "Cmds " or CNAME == "Commands " or CNAME == "cmds " or CNAME == "commands " then CINput.Text = "" return end
